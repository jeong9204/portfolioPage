        ...
        >
          ...
          >
            ...
            <p className={styles.profileSheetBody}>
              ...
              과정을 이해하게 되었고, 이는 UI 구조 설계와 기능 개발 전반을
              바라보는 중요한 기반이 되었습니다.
              <br />
              <br />
              이후 웹소설 플랫폼 서비스 기업에 합류하여 React 기반 실서비스
              개발을 담당했습니다. UI 초기 설계, 기능 구현, 운영 이슈 대응 및
              고도화까지 수행하며 단순 기능 구현을 넘어 서비스 안정성과 확장성을
              고려한 구조 설계를 실무에 적용했습니다. 특히 인증, 열람, 결제 등
              플랫폼의 주요 사용자 흐름을 이해하고 이를 기반으로 UI 구조를
              개선하며 서비스 전반의 사용자 경험과 안정성을 함께 고려했습니다.
              <br />
              <br />
              또한 하이브리드(WebView) 환경에서 발생한 인증(OAuth) 및 세션
              이슈를 분석하고 개선하며 서비스 안정성 향상에 기여했습니다. 사용자
